...
Now we get three different $S_{eff}$ form our three measurements by applying the second equation on the data. According to the first one, we now can calculate the real pumping speed and the conductances of both tubes. The real pumping speed should be around 8 litres per minute.
