...
\[ pV=nk_{B} T\]
 ...
 v=\sqrt{\frac{3kT}{m}}=644\frac{m}{s} \]
 \[ E_{thermal}=\frac{1}{2}mv^{2}=6.21*10^{-21}J \]
\\\\\\\\
...
\frac{1}{C_1} = \frac{1}{S_{eff-12}} - \frac{1}{S_{eff-2}}  \qquad
\frac{1}{C_2} = \frac{1}{S_{eff-12}} - \frac{1}{S_{eff-1}} \]
