...
R = R_1 + R_2 + ...  \quad C = \frac{1}{C_1} + \frac{1}{C_2} + ... \]
\[ Parrallel \: Connection: \quad
C = C_1 + C_2 + ...  \quad R = \frac{1}{R_1} + \frac{1}{R_2} + ... \]
...
Was fang ich mit den versch Seff an??
\\Wir sollen die C von den verschiedenen rohren bestimmen (und dann noch das reale S glaub ich). Wenn du die 3 Seff hast kannst du das als gleichungssystem aufschreiben und die einzelnen cs bestimmen.
...
Setting the mass spectrometer in the range from 1 to 50 amu we can compare our two measurements. The individual graphics are shown in \ref{MS Plots}.
