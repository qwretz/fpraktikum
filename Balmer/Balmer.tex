...
\begin{figure}[!h]
\centering
\includegraphics[width=.9\linewidth]{{Plots/Zink Linien.png}}
\caption{ }
\label{fig:Zink}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=.9\linewidth]{Plots/Ryd H.png}
...
\begin{figure}[!h]
\centering
\includegraphics[width=.9\linewidth]{Plots/Gitterkonstante.png}
\caption{Bestimmung der Monochromatorkonsante durch einen linearen Fit. Gewichtung des Fits mit Fehlern auf den gemessenen Winkel $\delta$. Zoom zur Veranschaulichung der einzelnen Datenpunkte. Wellenlängen wurden aus dem Skript zum Versuch \cite{skript} entnommen. }
\label{fig:MonoConst}
\end{figure}

% Werte /tabelle iwo hin kltschen...
Das Resultat aus dem linearen Fit entspricht innerhalb seines Fehlers genau dem Wert aus den gegebenen Werten. Mit dieser Übereinstimmung von ca. $99.96\%$ zum geometrischen Ergebnis kann man mit guten Gewissen im folgenden diesen Wert zur Bestimmung der Rydbergkonstanten benutzen.
